...
- [Day 4 - Model for Flask Frontend: House Prices](resources/SqFeetAndPriceHouse.ipynb)
...
- [Day 4 - Language Translation Flask App](resources/MyFlaskProject.zip)

- [Day 3 - Language Translation](resources/rnn-language-translation.md)
- [Day 4 - Named Entity Translation](resources/rnn-named-entity.md)
...
- [Day 2 - Using Pre-Trained ResNet50 for Image Classification Walkthrough](resources/resnet-walkthrougha.md)
- [Day 2 - Resnet50 Flask Frontend](resources/ImageRecognitionFlask.zip)
...
- [Day 3 - Summarization Steps](resources/summarization-steps.md) 
- [Day 4 - Walkthrough: Basic Functionalities of spaCy in Python](resources/walkthrough-spacy.md)   
- [Day 4 - BERT - Answers a Question](resources/bert-answers-a-question.md)
